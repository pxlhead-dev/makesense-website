...
const Automatization = () => {
  ...
  return (
    <section className="w-full flex justify-between items-center h-screen">
      <div className="w-full flex flex-col max-w-4xl px-4 mx-auto">
        ...
        <div className="w-full flex justify-between items-center">
          <div className="relative flex flex-col justify-start w-1/5 space-y-24">
          ...
          <div className="flex flex-col justify-center items-center">
            <animated.div style={styles} className="flex-none p-8 rounded-full bg-accent-indigo">
              <svg
                width="32"
                height="30"
                viewBox="0 0 32 30"
