    ...
    <Route path="/">
      ...
      <Scrollbar tabIndex={0} damping={0.2} className="w-screen h-screen overflow-hidden">
        <div className="max-w-5xl px-4 mx-auto">
          ...
          <section className="w-full flex flex-col justify-center items-center pt-24 mb-16">
            <div className="w-full flex justify-between items-end mb-16">
              <h2 className="font-display font-bold text-5xl max-w-lg">
          ...
          <section className="relative w-full flex justify-between items-end pt-24 pb-16">
            <div className="absolute top-0 left-0 w-full h-full bg-accent-indigo z-0" />
            <div className="flex-1 flex flex-col space-y-16 items-start z-10">
              ...
              <button className="flex space-x-2 items-center px-4 py-3.5 bg-primary-400 text-white rounded-xl cursor-pointer">
                <Zap size={16} />
                <span className="text-sm">I Want My Mind Palace</span>
              </button>
            </div>
            <div className="flex-1 flex flex-col space-y-8 items-end z-10">
              <p className="text-right">
                Stay for more? Subsribe to our Community Servers! Discuss Mind Mapping, AR, AI, Web
                and Sci-Fi and get in touch with us!
              </p>
              <button className="flex space-x-2 items-center px-4 py-3.5 bg-primary-400 text-white rounded-xl cursor-pointer">
                <Zap size={16} />
                <span className="text-sm">I Want My Mind Palace</span>
